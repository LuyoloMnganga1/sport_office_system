...
<?php
	if(isset($_POST['add_staff'])) //if button add_staff is clicked  then adding user
	{
					...
					<div class="wizard-content">
						...
						<form method="post" action="">
							<section>
								...
								<div class="row">
								<input name="leave_days" type="hidden" class="form-control" value="30" required="true" autocomplete="off">								
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
