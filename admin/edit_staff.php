		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-dark h4">Edit Staff</h4>
							<p class="mb-20"></p>
						</div>
					</div>
						...
						<form method="post" action="">
							<section>
								...
								<?php
									...
									?>
								<div class="row">
								<input name="leave_days" type="hidden" class="form-control" required="true" autocomplete="off"value="<?php echo $new_row['Av_leave']; ?>">									
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<div class="modal-footer justify-content-center">
												<button class="btn btn-dark" name="add_staff" id="add_staff" data-toggle="modal">Update&nbsp;Staff</button>
											</div>
										</div>
									</div>
								</div>
